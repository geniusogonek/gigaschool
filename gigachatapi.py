...
3. ТИП: ДОМАШНЕЕ ЗАДАНИЕ
   ...
   Формат ответа:
   {{"type": "homework", "date": "дата в формате ДД/ММ/ГГГГ", "subject_name": "точное название из списка выше", "text": "текст домашнего задания"}}
...
- subject_name должен ТОЧНО совпадать с одним из предметов в списке "ДОСТУПНЫЕ ПРЕДМЕТЫ"
